...
Research projects produce a chain of interdependent artifacts (questions, protocols, data, code, results, manuscripts), usually managed across disconnected tools with weak process traceability. This article asks how far GitHub's native features can serve as infrastructure for managing the research process itself, not just its code. Combining a bibliometric map of 5{,}139 works with a structured literature review, I derive fifteen research-management requirements and score GitHub against them. GitHub meets thirteen at least partially, seven directly, wherever research resembles software engineering, but falls short where the literature is also thinnest: research questions, planning and decisions. A reference architecture and a reusable repository template package what works; a year-long self-referential case study and a retrospective check on an unrelated clinical project suggest it transfers. GitHub will not replace research infrastructure, but it can become the coordination and traceability layer fragmented research workflows lack.
\end{abstract}
